...
PRESETS: Mapping[str, Preset] = MappingProxyType(
    {
        ...
        "bad_day": Preset(
            ...
            instruction=(
                "Add exactly one tired, unkempt, homeless-looking man naturally placed "
                "somewhere in the existing scene. He may be standing or sitting, "
                "whichever fits the composition better. Do not add any other people. "
                "Make him look like a real ordinary person who has had a hard time, "
                "not a horror character. He should have a natural human face, normal "
                "anatomy, and believable proportions. He may look poor, slightly "
                "dishevelled, and wear worn, modest clothes, but keep him visually "
                "realistic and not extreme. Do not make him grotesque, frightening, "
                "severely dirty, deformed, sick-looking, or low-quality. Do not add "
                "injuries, blood, missing teeth, exaggerated grime, extreme "
                "raggedness, or a disturbing appearance. He must not smoke or hold "
                "cigarettes, alcohol, drugs, weapons, or other inappropriate objects. "
                "Change only this. Preserve all existing people, faces, poses, "
                "clothing, furniture, objects, room layout, and background exactly as "
                "they are. If the source image contains no people, keep it that way "
                "except for this single added man. Match him carefully to the photo's "
                "lighting, perspective, shadows, camera quality, focus, and grain so "
